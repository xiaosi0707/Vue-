    ...
    <div class="store-content">
      <div class="cart-box">
        ...
        <div class="cart-inner">
          <div class="empty-label" :class="{'hide': shopCartGoods.length > 0}">
            <h3>您的购物车中还没有商品</h3>
            <router-link class="link" to="/">现在选购</router-link>
          </div>
          <div v-show="shopCartGoods.length > 0">
            ...
            <div class="cart-table">
              <div class="cart-group">
                <!--购物列表-->
                <div class="cart-top-items" v-for="(item, index) in shopCartGoods" :key="index">
                  <div class="cart-items">
                    <div class="items-choose">
                      <span class="blue-checkbox-new" :class="{'checkbox-on': item.checked}" @click="goodsCheckedHandle(item)"><a></a></span>
                    </div>
                    ...
                    <div class="operation">
                      <a class="items-delete-btn" @click="removeShopCartHandle(item)"></a>
                    </div>
                    ...
                    <span class="num">
                        ...
                        <span class="up" @click="increment(item)">+</span>
          ...
          <div class="cart-bar-operation">
            <div>
              <div class="choose-all js-choose-all">
                <span class="blue-checkbox-new" :class="{'checkbox-on': allCheckedState}" @click="allCheckedHandle"><a></a></span>
                全选
              </div>
          ...
          <div class="shipping">
            <div class="shipping-box">
              <div class="shipping-total shipping-num">
                <h4 class="">
                  已选择 <i>{{ shopCartGoodsTotal }}</i> 件商品
                </h4>
                <h5>
                  共计 <i>{{ shopCartGoodsTotal }}</i> 件商品
                </h5>
              </div>
              <div class="shipping-total shipping-price">
                <h4 class="">
                  应付总额：<span>￥</span><i>{{ shopCartGoodsPrice }}</i>
                </h4>
...
export default {
  ...
  methods: {
    ...
    // 选中商品
    goodsCheckedHandle (goods) {
      this.$store.commit('goodsChecked', goods)
    },
    // 全选
    allCheckedHandle () {
