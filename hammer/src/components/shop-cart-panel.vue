...
<span class="cart-empty-num" :class="{'cart-num': shopCartGoods.length}">
    ...
    <div class="nav-cart-wrapper" v-show="carShow">
      <div class="nav-cart-list">
        <div class="empty" v-if="!shopCartGoods.length">
          <h3>购物车为空</h3>
        ...
        <div class="full" v-else>
          <div class="nav-cart-items">
            <ul>
              <li class="clear" v-for="(item, index) in shopCartGoods" :key="index">
          ...
          <div class="nav-cart-total">
            ...
            <h6>
              <router-link class="nav-cart-btn" to="/shop-cart">去购物车</router-link>
            </h6>
          </div>
        </div>
      </div>
